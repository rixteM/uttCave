...
class ModelProducteur {
    ...
    public static function view() {
        printf("<tr><td>%d</td><td>%s</td><td>%s</td><td>%s</td></tr>", self::getId(), self::getNom(), self::getPrenom(), self::getRegion());
    }
...
// retourne une liste des id
    ...
    public static function delete($id) {
        try {
            ...
            printf("%s - %s<p/>\n", $e->getCode(), $e->getMessage());
            echo("<br> Problème de suppression du producteur. Il est probable qu'il soit présent dans la table des récoltes");
            return -1;
        }
    }
}
